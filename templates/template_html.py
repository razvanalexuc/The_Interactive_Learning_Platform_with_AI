...
.chat-message.user {
    background-color: #2b313e; /* Darker gray for user messages */
}

.chat-message.bot {
    background-color: #475063; /* Lighter gray for bot messages */
}
...
flashcard_template = """
<div id="flashcard-{{KEY}}" class="flashcard">
...
function flipCard(key) {
  var card = document.getElementById("flashcard-" + key);
